...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
    ...
    const prompt = `Generate resume for a candidate with the following details:
                        ...
                        The resume should not be so lengthy, it should ideally be 1 page long when converted to PDF. Focus on quality rather than quantity and make sure to include all the relevant information that can increase the candidate's chances of getting an interview call for the given job description.The content of Resume should not sound like it's generated by AI it should be as close as possible to a real human written-resume.Use compact but readable typography:
